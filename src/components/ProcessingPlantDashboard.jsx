...
export default function ProcessingPlantDashboard({ 
  ...
  // Inventory Stock & Distribution Combined
  ...
  return (
    <div className="app-container">
      ...
      <main className="main-content">
        ...
        {/* 2. INTAKE & EQUIPMENT (Combined Section)[cite: 2] */}
        {activeTab === 'intake-equipment' && (
          <div className="mgmt-sub-view" style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
        ...
        {/* 3. MONITORING & QUALITY (Combined Section)[cite: 2] */}
        {activeTab === 'monitoring-quality' && (
          <div className="mgmt-sub-view" style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
            <div className="glass-panel table-panel">
            ...
            <div className="glass-panel table-panel">
              <h3>🧪 Laboratory Quality Assurance Standards</h3>
              <table className="admin-table">
                <thead>
                  <tr>
                    <th>Batch ID</th>
                ...
                <tbody>
                  {compostPiles.map((pile) => (
                    <tr key={pile.id}>
                      ...
                      <td>
                        <span style={{ fontSize: '12px', color: 'var(--secondary)', fontWeight: '700' }}>Passed QA Standards</span>
                      </td>
                    </tr>
                  ))}
                </tbody>
        ...
        {/* 4. INVENTORY & DISTRIBUTION (Combined Section)[cite: 2] */}
        {activeTab === 'inventory-distribution' && (
          <div className="mgmt-sub-view" style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
            <div className="glass-panel table-panel">
        ...
        {/* 5. CARBON IMPACT & REPORTS[cite: 2] */}
        {activeTab === 'carbon' && (
        ...
        {/* 6. ADMINISTRATION & PROFILE (Combined Section)[cite: 2] */}
